...
@section('content')
            ...
            <section class="content">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{Form::model($invoice, ['route' => ['invoice.update', $invoice->codInv, 'contratos'], 'method' => 'PUT', 'onsubmit' => 'return validField()'])}}
    ...
    <script>
        function selectContratos() {
            const codEmp = $('#codEmp').find(":selected")[0].value;
        ...
        function selectContrato() {
            const numCtr = $('#numCtr').find(":selected")[0].value;
            const codEmp = $('#codEmp').find(":selected")[0].value;
