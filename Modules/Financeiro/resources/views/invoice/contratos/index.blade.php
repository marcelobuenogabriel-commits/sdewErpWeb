...
@section('content')
                        ...
                        <div class="card">
                            ...
                            <div class="card-header d-flex align-items-center">
                                ...
                                <span class="col-md-2 text-right">
                                    <a href="{{route('invoice.create', ['contratos'])}}">
                                                ...
                                                <tr>
                                                    @switch($contrato->usu_codemp)
                                                        ...
                                                        @case('4')
                                                            ...
                                                            @break
                                                    @endswitch
                                                    <td>{{$contrato->usu_codinv}}</td>
                                                    <td>{{$contrato->numctr}}</td>
                                                    <td>{{$contrato->nomcli}}</td>
                                                    <td>{{$contrato->usu_numver}}</td>
                                                    <td>{{ date('d/m/Y', strtotime($contrato->usu_datfec)) }}</td>
                                                    <td>
                                                        @include('partials.button_edit',[
                                                           $route = 'invoice.edit',
                                                           $class = 'invoice',
                                                           $object_id = $contrato->usu_codinv
                                                       ])
                                                        <button type="button"
                                                                title="Imprimir Invoice"
                                                                class="btn btn-dark itemModal"
                                                                data-toggle="modal"
                                                                data-codinv="{{ $contrato->usu_codinv }}"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Data início cobrança</label>
                                    <input type="date" name="txtDataCobranca" id="txtDataCobranca" required="required"
                                           class="form-control">
                                </div>
    ...
    <script>
        function printInvoice() {
            ...
            const emailKnapp = document.getElementById('txtEmailKnapp').value;
            const dataCobranca = document.getElementById('txtDataCobranca').value;
