...
@section('content')
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="seqOcp">Informe a Sequência da Ordem de Compra</label>
                            <input type="number" class="form-control" id="seqOcp" autocomplete="off">
                            @include('partials.error')
                        </div>

                        <div class="form-group">
                            <label for="qtdImp">Quantidade de Impressões</label>
                            <input type="number" class="form-control" id="qtdImp" autocomplete="off">
                            @include('partials.error')
                        </div>
    ...
    <script>
        function relOcoc() {
            ...
            seqOcp = parseInt(document.getElementById('seqOcp').value);
            qtdImp = parseInt(document.getElementById('qtdImp').value);
